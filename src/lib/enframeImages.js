...
export const IMAGE_DIRECTION = {
  ...
  highlights: [
    { src: cdnGallery("090a9634.jpg"), position: "50% 58%" },
    { src: cdnGallery("090a9347.jpg"), position: "52% 46%" },
    { src: cdnGallery("090a9625.jpg"), position: "50% 50%" },
    { src: cdnGallery("090a9628.jpg"), position: "50% 48%" },
